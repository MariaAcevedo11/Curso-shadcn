    ...
    <>
      ...
      <div className="flex overflow-hidden bg-white pt-16">
        ...
        >
          ...
          <footer className="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4 print:hidden"> {/* PARA FOKIN OCULTAR EL FOOTER CUANDO SE VAYA A IMPRIMIR INCreIBLE */}
